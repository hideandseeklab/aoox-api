...
export class CreateApplicationDto {
  ...
  /** Public git URL (https://... or git://...); required for the `git` source. */
  @ValidateIf((o: { sourceType?: string }) => o.sourceType !== 'image')
  @IsString()
  @MaxLength(500)
  @Matches(/^(https?|git):\/\/[^\s#@]+$/, {
    message:
  ...
  /** Successful deployments kept for rollback (default 10). */
  @IsOptional()
  @IsInt()
  @Min(1)
  @Max(100)
